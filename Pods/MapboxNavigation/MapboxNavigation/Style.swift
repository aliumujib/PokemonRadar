...
fileprivate extension UIColor {
    ...
    fileprivate class var defaultTint: UIColor { get { return PRIMARY_COLOR } }
    fileprivate class var defaultTintStroke: UIColor { get { return PRIMARY_COLOR } }
    ...
    fileprivate class var defaultSecondaryText: UIColor { get { return #colorLiteral(red: 0.9999160171, green: 1, blue: 0.9998719096, alpha: 1) } }
    fileprivate class var defaultLine: UIColor { get { return #colorLiteral(red: 0.9999160171, green: 1, blue: 0.9998719096, alpha: 1) } }
    
    // Maneuver view (Page view)
    fileprivate class var defaultManeuverViewBackground: UIColor { get { return PRIMARY_COLOR } }
    
    // Table view (Drawer)
    fileprivate class var defaultHeaderBackground: UIColor { get { return PRIMARY_COLOR } }
